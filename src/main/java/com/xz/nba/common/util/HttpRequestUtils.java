...
public class HttpRequestUtils {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(httpGet("http://matchweb.sports.qq.com/kbs/list?from=NBA_PC&columnId=100000&startTime=2018-12-20&endTime=2018-12-20", null, null, 6000, false));
